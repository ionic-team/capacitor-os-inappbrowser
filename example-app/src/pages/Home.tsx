        ...
        <div>
          ...
          >
            ...
            <IonItem>
              ...
              <IonInput
                value={testUrl}
                onIonChange={(e) => setTestUrl(e.detail.value!)}
              />
            </IonItem>
            <IonItem>
              ...
              <IonToggle
                checked={isIsolated}
                onIonChange={(e) => setIsIsolated(e.detail.checked)}
              />
            </IonItem>
            <p style={{ fontSize: "0.8em", color: "#666" }}>
              <strong>To replicate shared storage on API &lt; 28:</strong>
              <br />
              1. Show the "Site Setter" below.
              <br />
              2. Use the embedded page to set a value.
              <br />
              3. Tap "2. Open Site (InAppBrowser)". It should share the value.
              <br />
              <br />
              <strong>On API 28+ (Isolated):</strong>
              <br />
            ...
            <IonButton
              expand="block"
              color="tertiary"
              onClick={openLocalStorageTestInWebView}
            >
              2. Open Site (InAppBrowser)
            </IonButton>
            <IonButton
              expand="block"
              fill="outline"
              onClick={() => router.push("/local-storage-test")}
            >
              Go to Local Test Component
            </IonButton>
          </div>
